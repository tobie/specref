...
var w3c = JSON.parse(fs.readFileSync('./refs/w3c.json', 'utf8'));
var legacy = JSON.parse(fs.readFileSync('./refs/legacy.json', 'utf8'));
var PROPS =  [
    "id",
    "authors",
    "etAl",
...
module.exports = new Bibref(json, ietf, w3c, legacy);
module.exports.doneAddingRefs();
